...
[![Stars](https://img.shields.io/github/stars/biswarup001/aws-retail-sample-store-in-eks)](Stars)
![GitHub License](https://img.shields.io/github/license/biswarup001/aws-retail-sample-store-in-eks?color=green)
![Dynamic JSON Badge](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fraw.githubusercontent.com%biswarup001%2Faws-retail-sample-store-in-eks%2Frefs%2Fheads%2Fmain%2F.release-please-manifest.json&query=%24%5B%22.%22%5D&label=release)
...
- [Cleanup](https://github.com/biswarup001/aws-retail-sample-store-in-eks/blob/main/README.md#step-12-cleanup)
...
3. **Clone Repository**: `git clone https://github.com/biswarup001/aws-retail-sample-store-in-eks.git`
...
```sh
git clone https://github.com/biswarup001/aws-retail-sample-store-in-eks.git
```
...
```sh
cd aws-retail-sample-store-in-eks/terraform/
terraform init
...
- **Issues**: [GitHub Issues](https://github.com/biswarup001/aws-retail-sample-store-in-eks/issues)
- **Discord**: [TrainWithShubhamCommunity](https://discord.gg/)
